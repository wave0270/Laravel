    ...
    init: function() {
        ...
        if(!articleContent) {
            ...
            articleContent.innerHTML = [
                "<p>Sorry, My tool was unable to parse this page for content. If you feel like it should have been able to",
                (readability.frameHack ? "<p><strong>It appears this page uses frames.</strong> Unfortunately, browser security properties often cause My tool to fail on pages that include frames. You may want to try running readability itself on this source page: <a href='" + readability.biggestFrame.src + "'>" + readability.biggestFrame.src + "</a></p>" : ""),
                "<p>Also, please note that My tool does not play very nicely with front pages. My tool is intended to work on articles with a sizable chunk of text that you'd like to read comfortably. If you're using My tool on a landing page (like nytimes.com for example), please click into an article first before using My tool.</p>"
            ].join('');
        ...
        //admore
        var arr = {title:articleTitle,content:articleContent,footer:articleFooter,tool:articleTools};
        return arr;   
        ...
        **/
        if((window.location.protocol + "//" + window.location.host + "/") === window.location.href)
        {
            ...
            var rootWarning = document.createElement('p');
                ...
                rootWarning.innerHTML = "<em>My tool</em> was intended for use on individual articles and not home pages. " +
    ...
    getArticleFooter: function () {
        ...
        "<div id='rdb-footer-wrapper'>",
             "<div id='rdb-footer-left'>",
                 "<a href='http://lab.arc90.com/experiments/readability' id='readability-logo'>My tool &mdash;&nbsp;</a>",
             ...
             "<div id='rdb-footer-right'>",
                 ...
                 "<span class='version'>My tool version " + readability.version + "</span>",
             "</div>",
        "</div>"].join('');
